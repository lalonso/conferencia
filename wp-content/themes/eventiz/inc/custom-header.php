<?php
/**
 * Implement Custom Header functionality for Eventiz
 *
 * @package WpOpal
 * @subpackage Eventiz
 * @since Eventiz 1.0
 ...
 * @since Eventiz 1.0
 *
 * @uses eventiz_fnc_header_style()
 * @uses eventiz_fnc_admin_header_style()
 * @uses eventiz_fnc_admin_header_image()
 */
function eventiz_fnc_custom_header_setup() {
	/**
	 * Filter Eventiz custom-header support arguments.
	 *
	 * @since Eventiz 1.0
	 *
	 * @param array $args {
	 ...
	 * }
	 */
	add_theme_support( 'custom-header', apply_filters( 'eventiz_fnc_custom_header_args', array(
		'default-text-color'     => 'fff',
		'width'                  => 1260,
		'height'                 => 240,
		'flex-height'            => true,
		'wp-head-callback'       => 'eventiz_fnc_header_style',
		'admin-head-callback'    => 'eventiz_fnc_admin_header_style',
		'admin-preview-callback' => 'eventiz_fnc_admin_header_image',
	) ) );
}
add_action( 'after_setup_theme', 'eventiz_fnc_custom_header_setup' );

if ( ! function_exists( 'eventiz_fnc_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog
 *
 * @see eventiz_fnc_custom_header_setup().
 *
 */
function eventiz_fnc_header_style() {  
...
endif; // eventiz_fnc_header_style


if ( ! function_exists( 'eventiz_fnc_admin_header_style' ) ) :
/**
 ...
 * @since Eventiz 1.0
 */
function eventiz_fnc_admin_header_style() {  
?>
	<style type="text/css" id="eventiz-admin-header-css">
...
endif; // eventiz_fnc_admin_header_style

if ( ! function_exists( 'eventiz_fnc_admin_header_image' ) ) :
/**
 ...
 * @since Eventiz 1.0
 */
function eventiz_fnc_admin_header_image() {
?>
	<div id="headimg">
...
endif; // eventiz_fnc_admin_header_image