...
<div class="pbr-topcart">
 <div id="cart" class="dropdown version-3">
        
        <a class="dropdown-toggle mini-cart" data-toggle="dropdown" aria-expanded="true" role="button" aria-haspopup="true" data-delay="0" href="#" title="<?php esc_html_e('View your shopping cart', 'eventiz'); ?>">
