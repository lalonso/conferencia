...
<div id="page" class="hfeed site"><div class="pbr-page-inner row-offcanvas row-offcanvas-left">
   ...
   <?php endif; ?>
   <?php 
      remove_action( 'eventiz_template_header_before', 'eventiz_fnc_topbar_layout' );
   ...
   <header id="pbr-masthead" class="site-header header-absolute" role="banner">
      <div class="container"><div class="row">
         ...
         <section id="pbr-mainmenu" class="pbr-mainmenu col-lg-10 col-md-10 col-sm-12 col-xs-12 pull-right">      
              <div class="inner navbar-mega-simple navbar-mega-light pull-right"><?php get_template_part( 'page-templates/parts/nav' ); ?></div>
                          ...
                          <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  <h4 id="gridSystemModalLabel" class="modal-title"><?php esc_html_e("Search",'eventiz');?></h4>
                                </div>
