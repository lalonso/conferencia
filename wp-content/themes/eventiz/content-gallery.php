...
$galleries = eventiz_fnc_get_post_galleries();
?>
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		<?php
			...
			wp_link_pages( array(
				'before'      => '<div class="page-links clearfix loop-pagination"><span class="page-links-title">' . esc_html__( 'Pages:', 'eventiz' ) . '</span>',
				'after'       => '</div>',
				'link_before' => '<span>',
				'link_after'  => '</span>',
			) );
