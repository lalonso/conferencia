...
global $eventiz_wpopconfig, $pbrmegamenu ;

if( isset($eventiz_wpopconfig['layout']) && $eventiz_wpopconfig['layout'] != 'fullwidth' ){
   $classContainer = $classContainer;
} 
 
if(   $pbrmegamenu ){
	$wrapper_attributes[] = 'class="wpb-container-mega ' . esc_attr( trim( $css_class ) ) . '"';
    $classContainer = 'container-mega';
} else {
	$wrapper_attributes[] = 'class="wpb-container ' . esc_attr( trim( $css_class ) ) . '"';
}
...
$output .='<div class="'.$classContainer.(!$isfullwidth?'-full':'').'">'.$icon;

$output .= '<div class="'.implode(' ',$rowcls ).'">';
