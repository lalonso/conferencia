	...
	<?php if($query->have_posts()){ ?>
		...
		<?php } ?>
			...
			<div id="carousel-<?php echo esc_attr($_id); ?>" class="widget-content text-center owl-carousel-play" data-ride="owlcarousel">
					<div class="owl-carousel " data-slide="<?php echo esc_attr($number); ?>" data-pagination="<?php echo esc_attr($pagination); ?>" data-navigation="true" data-desktop="[1199,2]" data-desktopsmall="[980,1]" data-tablet="[768,1]">
				...
				<?php if( ($number < $_count) && $arrow=='true') { ?>
